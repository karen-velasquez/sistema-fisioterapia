...
class Exercises:
    ...
    '''++++++++++++++++++++++++++ELONGACION++++++++++++++++++++++'''
    def extension_rodilla_agarrar_punta (self, landmarks):
        list_threads = []
        global counter
        global stage
        global engine
        ...
        angle = self.calculate_angle(self, left_hip, left_knee, left_ankle)
    ...
    def extension_tobillo_bandas (self, landmarks):
        list_threads = []
        global counter
        global stage
        global engine
        ...
        # Calculando el angulo de los tres puntos enviados
        angle = self.calculate_angle(left_knee, left_ankle, left_foot_index)
    ...
    def flexion_rodilla (self, landmarks):
        list_threads = []
        global counter
        global stage
        global engine
    ...
    '''+++++++++++++++++++++++++++++++++FORTALECIMIENTO++++++++++++++++++++++++++++'''
    def elevacion_tobillo(self, landmarks):
        list_threads = []
        global counter
        global stage
        global engine
        ...
        second_angle = self.calculate_angle(self, left_knee, left_ankle, left_foot_index)
    ...
    def sentadilla_1(self, landmarks):
        list_threads = []
        global counter
        global stage
        global engine
    ...
    def ejercicio_cobra(self, landmarks):
        list_threads = []
        global counter
        global stage
        global engine
        ...
        # Calculando el angulo de los tres puntos enviados
        angle = self.calculate_angle(self, left_shoulder, left_elbow, left_wrist)
    ...
    def extension_arriba_atras(self, landmarks):
        list_threads = []
        global counter
        global stage
        global engine
        ...
        # Calculando el angulo de los tres puntos enviados
        second_angle = self.calculate_angle(self, right_shoulder, right_elbow, right_wrist)
    ...
    '''+++++++++++++++++++++++++++++++++++++++++++++++++ FORTALECIMIENTO ++++++++++++++++++++++++++++++++++++'''
    def remos_dorsales(self, landmarks):
        list_threads = []
        global counter
        global stage
        global engine
    ...
    def pose_estimation(self, cap, mp_pose):
        global counter
        ...
        with mp_pose.Pose(
            ...
            while True:
                ...
                try:
                    ...
                    angle = self.sentadilla(landmarks)
...
def sentadilla(landmarks, mp_pose):
    global counter
    global stage
    global engine
    global feedback
    ...
    if angle < 90 and stage == 'down':
        ...
        target_thread= threading.Thread(
            target=Exercises.threadexample1, args=(), kwargs={}
        )
    ...
    ## Setup mediapipe instance
def pose_estimation2(frame, pose , mp_drawing, mp_pose):
    global counter
    # Recolor image to RGB
    image = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
    image.flags.writeable = False
